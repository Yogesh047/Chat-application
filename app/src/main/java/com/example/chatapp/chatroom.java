...
import com.example.chatapp.MessagesAdater;
...
public class chatroom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messagesArrayList = new ArrayList<>();
        adater = new MessagesAdater(chatroom.this, messagesArrayList);
        ...
        sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (message.isEmpty()) {
                    Toast.makeText(chatroom.this, "Please enter Valid Message", Toast.LENGTH_SHORT).show();
                    return;
                }
                edtMessage.setText("");
                Date date = new Date();

                final Messages messages = new Messages(message, SenderUID, date.getTime());
